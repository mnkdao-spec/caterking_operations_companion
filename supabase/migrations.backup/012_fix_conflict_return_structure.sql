-- Migration 012: Fix check_staff_conflicts Return Structure
-- Description: Updates the function to return the structure expected by TypeScript
--              (conflict_type, conflict_start, conflict_end, conflict_details)
-- Date: 2026-01-09
-- Author: Manus AI
...
COMMENT ON FUNCTION check_staff_conflicts IS 'Checks for scheduling conflicts when assigning staff to events. Returns list of conflicts with type, start/end times, and details. Uses SECURITY DEFINER with explicit search_path for security.';
